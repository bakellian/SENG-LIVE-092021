...
zachary = Donor.create(name: "Zachary", email: "zachary@email.com")#storing inside variable because eventually we will crete a dontion associated with this person and we need a way to reference it
teamseas = Organization.create(name: 'Team Seas') #storing inside variable because eventually we will crete a dontion associated with this org and we need a way to reference it
